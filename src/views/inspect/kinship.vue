...
<script>
import { Tab, Tabs, Form, Field, Picker, Popup, Button ,PullRefresh,List,Cell} from "vant";
...
export default {
  ...
  data() {
    return {
      ...
      solution:'',//解决方式
      showSolution:false,
      solutionList:['报备','无需报备','本人内部调动','对方内部调动','本人离职','对方离职'],
      relation:'',//与申报人关系
      showRelation:false,
      RelationList:[
          {
              text:'直系',
              children:[{text:'夫妻'},{text:'父子(包括女儿)'},{text:'母子(包括女儿)'}]
          },
          {
            text:'旁系',
            children:[{text:'伯侄'},{text:'叔侄'},{text:'姑侄'},{text:'舅甥'},{text:'姨甥'},{text:'亲兄弟姐妹'}] //写死数据 数据没写完
          }
      ],
      bookList:[], //登记列表
      loading: false,
